<footer class="bg-white rounded-lg shadow-sm dark:bg-gray-900 p-4 mt-16">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2005 <a href="https://www.silverstripe.org">SilverStripe</a>. All Rights Reserved.</span>
    </div>
</footer>
